...
* **Empirical Multi-Model & Compiler Benchmark**: Comprehensive evaluation across **8 model families and live compilers (`zig`, `cargo`, `tsc`)** (see [BENCHMARK.md](BENCHMARK.md)).
